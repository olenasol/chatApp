...
public class MessageListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType != Constants.VIEW_ITEM) {
            ...
            vh = new IncommingMessageHolder(view);
        } else {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof IncommingMessageHolder){
            ((IncommingMessageHolder) holder).messageTxt.setText(listOfMessages.get(position).getMessage());
            ((IncommingMessageHolder) holder).timeTxt.setText(listOfMessages.get(position).getTime());

        }
        else {
            ((OtherMessageHolder) holder).messageTxt.setText(listOfMessages.get(position).getMessage());
            ((OtherMessageHolder) holder).timeTxt.setText(listOfMessages.get(position).getTime());
        }
    }
    ...
    public void addToListOfMessages(Message message){
        listOfMessages.add(message);
        notifyDataSetChanged();
    }
}
